#Code reference: https://www.redteam.cafe/red-team/powershell/using-reflection-for-amsi-bypass 
#Based on: http://www.exploit-monday.com/2012/05/accessing-native-windows-api-in.html
